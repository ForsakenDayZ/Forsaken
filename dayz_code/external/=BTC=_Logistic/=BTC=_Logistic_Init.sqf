...
[] execVM "\z\addons\dayz_code\external\=BTC=_Logistic\=BTC=_Lift\=BTC=_LiftInit.sqf";
...
BTC_get_liftable_array =
{
	...
	switch (typeOf _chopper) do
	{
		...
		case "UH60M_EP1_DZE"   : {_array = ["Motorcycle","Car","Truck"];};
		case "UH60M_EP1_DZ"   : {_array = ["Motorcycle","Car","Truck"];};
		case "BAF_Merlin_HC3_D": {_array = ["Motorcycle","Car","Truck","Wheeled_APC","Tracked_APC"];};
		case "MH60S"           : {_array = ["Motorcycle","Car","Truck"];};
