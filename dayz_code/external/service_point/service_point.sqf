...
// general settings
_folder = "\z\addons\dayz_code\external\service_point\"; // folder where the service point scripts are saved, relative to the mission file
...
_refuel_amount = 0.07; // amount of fuel to add with every update (in percent)
