...
private ["_Transporter","_Unit","_BTK_CargoDrop_ActionAdded","_CargoAction"];
...
_CargoAction = _Transporter addAction [("<t color=""#fadfbe"">" + ("Load cargo") + "</t>"),"z\addons\dayz_code\external\BTK\Cargo Drop\Engine.sqf",["LoadCargo"], 5, false, false, "", "vehicle _this == player"];
