class Life_RscScrollBar
{
	...
	thumb = "\z\addons\dayz_code\external\gui\thumb_ca.paa";
	arrowEmpty = "\z\addons\dayz_code\external\gui\arrowEmpty_ca.paa";
	arrowFull = "\z\addons\dayz_code\external\gui\arrowFull_ca.paa";
	border = "\z\addons\dayz_code\external\gui\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscTree {
	...
	expandedTexture = "\z\addons\dayz_code\external\gui\expandedTexture_ca.paa";
	hiddenTexture = "\z\addons\dayz_code\external\gui\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "\z\addons\dayz_code\external\gui\normal_ca.paa";
	animTextureNormal = "\z\addons\dayz_code\external\gui\normal_ca.paa";
	animTextureDisabled = "\z\addons\dayz_code\external\gui\normal_ca.paa";
	animTextureOver = "\z\addons\dayz_code\external\gui\over_ca.paa";
	animTextureFocused = "\z\addons\dayz_code\external\gui\focus_ca.paa";
	animTexturePressed = "\z\addons\dayz_code\external\gui\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "\z\addons\dayz_code\external\gui\main\normal_ca.paa";
	animTextureDisabled = "\z\addons\dayz_code\external\gui\main\disabled_ca.paa";
	animTextureOver = "\z\addons\dayz_code\external\gui\main\over_ca.paa";
	animTextureFocused = "\z\addons\dayz_code\external\gui\main\focus_ca.paa";
	animTexturePressed = "\z\addons\dayz_code\external\gui\main\down_ca.paa";
	animTextureDefault = "\z\addons\dayz_code\external\gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "\z\addons\dayz_code\external\gui\slider\arrowEmpty_ca.paa";
	arrowFull = "\z\addons\dayz_code\external\gui\slider\arrowFull_ca.paa";
	border = "\z\addons\dayz_code\external\gui\slider\border_ca.paa";
	thumb = "\z\addons\dayz_code\external\gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "\z\addons\dayz_code\external\gui\arrow_left_ca.paa";
	nextPage = "\z\addons\dayz_code\external\gui\arrow_right_ca.paa";
	shadow = 2;
...
class Life_RscCombo {
	...
	arrowFull = "\z\addons\dayz_code\external\gui\arrowFull_sca.paa";
	arrowEmpty = "\z\addons\dayz_code\external\gui\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
