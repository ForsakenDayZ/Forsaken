...
*/
//Player only
	BIS_fnc_numberDigits 	= compile preprocessFileLineNumbers "\z\addons\dayz_code\external\gold\numberDigits.sqf";
	BIS_fnc_numberText 	= compile preprocessFileLineNumbers "\z\addons\dayz_code\external\gold\numberText.sqf";
// usage
...
if (!isDedicated) then {
   ...
   if (dayz_clientPreload && dayz_authed) exitWith {
	...
	if (isServer) then {
		...
		call compile preprocessFileLineNumbers "\z\addons\dayz_code\external\gold\player_traderMenu.sqf";
initialized = true;