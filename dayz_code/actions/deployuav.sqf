private ["_player","_caller","_rq11_body","_rq11_tail","_rq11_paddle","_rq11_rotor","_rq11_wing_m","_rq11_wing_lr","_rq11_camera","_ravenStatic","_blanket","_rq11_rotor2","_rq11_paddle2","_rq11_camera2","_rq11_camera3","_backpackRavenBatteryLevel","_bodyRavenBatteryLevel"];
_player = player;
_caller = _this select 1;

_blanket = "carpet_empty" createVehicle position _player;
_blanket setPosASL [getPosASL _player select 0, getPosASL _player select 1, getPosASL _player select 2];
