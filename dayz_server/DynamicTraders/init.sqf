...
_trader_config = [
	[8, "ATM.sqf", 		"", 					"ColorBlue"],
	//[0, "hero.sqf", 		"Hero Trader", 					"Color"],
	//[0, "bandit.sqf", 		"Bandit Trader", 				"Color"],
	[1, "general.sqf", 		"", 	"ColorGreen"],
	[1, "helicopters.sqf", 	"", 					"ColorYellow"],
	[1, "medical.sqf", 		"", 				"ColorRed"],
	[1, "vehicles.sqf", 	"", 				"ColorOrange"],
	[1, "weapons.sqf", 		"", 				"ColorBlack"],
	[1, "black_mkt.sqf", 	"", 					"ColorBrown"],
	[1, "boat.sqf", 		"", 						"ColorKhaki"]
]; 
